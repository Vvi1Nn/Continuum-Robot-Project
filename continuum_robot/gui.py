...
class ControlPanel(QMainWindow):
    def __init__(self) -> None:
        ...
        # self.usbcan_0 = self.robot.usbcan_0
        # self.usbcan_1 = self.robot.usbcan_1
        # self.motor_1 = self.robot.motor_1
        # self.motor_2 = self.robot.motor_2
        # self.motor_3 = self.robot.motor_3
        # self.motor_4 = self.robot.motor_4
        # self.motor_5 = self.robot.motor_5
        # self.motor_6 = self.robot.motor_6
        # self.motor_7 = self.robot.motor_7
        # self.motor_8 = self.robot.motor_8
        # self.motor_9 = self.robot.motor_9
        # self.motor_10 = self.robot.motor_10
        # self.sensor_1 = self.robot.sensor_1
        # self.sensor_2 = self.robot.sensor_2
        # self.sensor_3 = self.robot.sensor_3
        # self.sensor_4 = self.robot.sensor_4
        # self.sensor_5 = self.robot.sensor_5
        # self.sensor_6 = self.robot.sensor_6
        # self.sensor_7 = self.robot.sensor_7
        # self.sensor_8 = self.robot.sensor_8
        # self.sensor_9 = self.robot.sensor_9
        # self.sensor_10 = self.robot.sensor_10
        # self.io = self.robot.io
        # self.usbcan_0 = UsbCan.set_device_type(type="USBCAN2", index="0").is_show_log(False)("0")
        # self.usbcan_1 = UsbCan.set_device_type(type="USBCAN2", index="0").is_show_log(False)("1")
    ...
    def test_move(self):
        ...
        #                                  self.motor_4, self.motor_5, self.motor_6, 
        #                                  self.motor_7, self.motor_8, self.motor_9,
        #                                  self.sensor_1, self.sensor_2, self.sensor_3, 
        #                                  self.sensor_4, self.sensor_5, self.sensor_6, 
        #                                  self.sensor_7, self.sensor_8, self.sensor_9)
        self.test_move_thread = MoveTestNew(self)
...
class MoveTest(QThread):
    def __init__(self, motor: Motor, io: IoModule, 
                 ...
                 rope_7: Motor, rope_8: Motor, rope_9: Motor,
                 sensor_1: Sensor, sensor_2: Sensor, sensor_3: Sensor, 
                 sensor_4: Sensor, sensor_5: Sensor, sensor_6: Sensor, 
                 sensor_7: Sensor, sensor_8: Sensor, sensor_9: Sensor) -> None:
        ...
        self.__sensor_3 = sensor_3
        self.__sensor_4 = sensor_4
        self.__sensor_5 = sensor_5
        self.__sensor_6 = sensor_6
        self.__sensor_7 = sensor_7
        self.__sensor_8 = sensor_8
        self.__sensor_9 = sensor_9
    ...
    def run(self):
        ...
        self.__rope_1.set_control_mode("speed_control", check=False)
        self.__rope_2.set_control_mode("speed_control", check=False)
        self.__rope_3.set_control_mode("speed_control", check=False)
        self.__rope_4.set_control_mode("speed_control", check=False)
        self.__rope_5.set_control_mode("speed_control", check=False)
        self.__rope_6.set_control_mode("speed_control", check=False)
        self.__rope_7.set_control_mode("speed_control", check=False)
        self.__rope_8.set_control_mode("speed_control", check=False)
        self.__rope_9.set_control_mode("speed_control", check=False)

        self.__rope_1.set_speed(0, is_pdo=True)
        self.__rope_2.set_speed(0, is_pdo=True)
        self.__rope_3.set_speed(0, is_pdo=True)
        self.__rope_4.set_speed(0, is_pdo=True)
        self.__rope_5.set_speed(0, is_pdo=True)
        self.__rope_6.set_speed(0, is_pdo=True)
        self.__rope_7.set_speed(0, is_pdo=True)
        self.__rope_8.set_speed(0, is_pdo=True)
        self.__rope_9.set_speed(0, is_pdo=True)

        self.__rope_1.halt(is_pdo=True)
        self.__rope_2.halt(is_pdo=True)
        self.__rope_3.halt(is_pdo=True)
        self.__rope_4.halt(is_pdo=True)
        self.__rope_5.halt(is_pdo=True)
        self.__rope_6.halt(is_pdo=True)
        self.__rope_7.halt(is_pdo=True)
        self.__rope_8.halt(is_pdo=True)
        self.__rope_9.halt(is_pdo=True)

        self.__rope_1.enable_operation(is_pdo=True)
        self.__rope_2.enable_operation(is_pdo=True)
        self.__rope_3.enable_operation(is_pdo=True)
        self.__rope_4.enable_operation(is_pdo=True)
        self.__rope_5.enable_operation(is_pdo=True)
        self.__rope_6.enable_operation(is_pdo=True)
        self.__rope_7.enable_operation(is_pdo=True)
        self.__rope_8.enable_operation(is_pdo=True)
        self.__rope_9.enable_operation(is_pdo=True)

        times = 2
        while not self.__is_stop and times != 0:
            self.ballscrew_move_abs(self.__inside_start, velocity=8.59375)
            ...
            self.__motor.set_position(position_2, velocity=10, is_pdo=True)
            ...
            # time.sleep((10 * 5120) / (100 * 440) + 0.2)
            time.sleep(0.5)
            
            while True:
                self.__rope_1.set_speed(int((-4 - self.__sensor_1.force) * 10), is_pdo=True)
                self.__rope_2.set_speed(int((-4 - self.__sensor_2.force) * 10), is_pdo=True)
                self.__rope_3.set_speed(int((-4 - self.__sensor_3.force) * 10), is_pdo=True)
                self.__rope_4.set_speed(int((-4 - self.__sensor_4.force) * 10), is_pdo=True)
                self.__rope_5.set_speed(int((-4 - self.__sensor_5.force) * 10), is_pdo=True)
                self.__rope_6.set_speed(int((-4 - self.__sensor_6.force) * 10), is_pdo=True)
                self.__rope_7.set_speed(int((-4 - self.__sensor_7.force) * 10), is_pdo=True)
                self.__rope_8.set_speed(int((-4 - self.__sensor_8.force) * 10), is_pdo=True)
                self.__rope_9.set_speed(int((-4 - self.__sensor_9.force) * 10), is_pdo=True)

                if self.__motor.current_position == position_2:
        ...
        # times = 14
        # while not self.__is_stop and times != 0:
        #     self.ballscrew_move_abs(227, velocity=8.59375)
        ...
        #     self.__motor.set_position(self.__motor.zero_position - 237 * 5120, velocity=100, is_pdo=True)
        #     self.__rope_1.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
        #     self.__rope_2.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
        #     self.__rope_3.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
        #     self.__rope_4.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
        ...
        # times = 14
        # while not self.__is_stop and times != 0:
        #     self.ballscrew_move_abs(100, velocity=8.59375)
        ...
        #     self.__motor.set_position(self.__motor.zero_position - 110 * 5120, velocity=100, is_pdo=True)
        #     self.__rope_1.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
        #     self.__rope_2.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
        #     self.__rope_3.set_position(int(10 * 12536.512440), velocity=245, is_pdo=True)
...
class MoveTestNew(QThread):
    def __init__(self, robot: ControlPanel) -> None:
